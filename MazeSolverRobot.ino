...
#define rightNearSensor    11//CHANGES
#define rightFarSensor     12//CHANGES
#define forwardSensor      14//CHANGES
#define redLed             15//CHANGES
...
void setup(){
  ...
  pinMode(forwardSensor,INPUT);// CHANGES
...
void straight(){
  forwardReading   = analogRead(forwardSensor);
    if(forwardReading<200)
    {
     digitalWrite(redLed,HIGH);
     delay(1000);
     digitalWrite(redLed,LOW);
     done();// detects the block
